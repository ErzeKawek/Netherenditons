package net.erzekawek.areasundiscovered.world.features;
...
import net.erzekawek.areasundiscovered.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, AreasUndiscoveredMod.MODID);
